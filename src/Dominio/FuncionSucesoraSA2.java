...
public class FuncionSucesoraSA2 implements SuccessorFunction {

    private static int DENOMINADOR_OPERADORES = 293;
        ...
        while (!valid) {
            ...
            if (opt < 87) {
                ...
                if (state.puedeRecogerBicis(f, j)) {
                    ...
                    FuncionHeuristicaC1 fhc1 = new FuncionHeuristicaC1();
                    fhc1.getHeuristicValue(nuevoEstado);
                    retVal.add(new Successor(Estado.RECOGER_BICIS + " #"+n+"# [[" + j + "]]", nuevoEstado));
                    valid = true;
                }
            }
