...
public class FuncionSucesoraHillClimbing2 implements SuccessorFunction {
    ...
    public List getSuccessors(Object aState) {
        ...
        for (int i = 0 ; i < furgonetas.size();++i) {
            ...
            if (estado.puedeAnadirFurgoneta(i))
            {
                Estado nuevoEstado = new Estado(estado);
                nuevoEstado.anadirFurgoneta(i);
                retVal.add(new Successor(Estado.ANADIR_FURGONETA+" @"+i+"@ ", nuevoEstado));
            }
